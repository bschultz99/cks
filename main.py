...
if __name__ == "__main__":
    ...
    cursor = conn.cursor()
    cursor.execute("DROP TABLE applicants IF EXISTS CASCADE;")
    conn.commit()
    cursor.execute("DROP TABLE applications IF EXISTS CASCADE;")
    conn.commit()
    cursor.execute("DROP TABLE reviewers IF EXISTS CASCADE;")
    conn.commit()
    cursor.execute("DROP TABLE reviews IF EXISTS CASCADE;")
    conn.commit()
